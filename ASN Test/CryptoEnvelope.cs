...
namespace RSA__Lab_1_
{
    internal class CryptoEnvelope
    {
        ...
        public void GenerateRSAKeys(int keySize)
        {
        ...
        public BigInteger RSAEncrypt(BigInteger data, RSAPrivateKey key)
        {
            return BigInteger.ModPow(data, key.D, key.N);
        }

        public BigInteger RSAEncrypt(BigInteger data, RSAPublicKey key)
        {
            return BigInteger.ModPow(data, key.E, key.N);
        }

        public BigInteger RSADecrypt(BigInteger data, RSAPrivateKey key)
        {
            return BigInteger.ModPow(data, key.D, key.N);
        }

        public BigInteger RSADecrypt(BigInteger data, RSAPublicKey key)
        {
            return BigInteger.ModPow(data, key.E, key.N);
        }
        ...
        public byte[] Sign(RSAPublicKey publicKey, RSAPrivateKey privateKey, byte[] data)
        {
        ...
        public byte[] EncryptFile(RSAPublicKey rsaPublicKey, byte[] AESKey, byte[] data)
        {
        ...
        public byte[] DecryptFile(RSAPrivateKey rsaPrivateKey, byte[] data) 
        {
